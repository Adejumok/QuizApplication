# QuizApplication
A quiz application developed using Spring Boot framework, written in Java language. where a user takes a quiz, fills a form containing the user's email address and gets the result of the quiz in his/her mail.
